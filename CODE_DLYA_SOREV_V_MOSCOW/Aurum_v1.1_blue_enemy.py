...
threshold_blue=(13, 33, -128, 127, -128, -22)
threshold_yellow=(51, 96, -18, 46, 22, 115)
pyb.LED(1).on()
pyb.LED(2).on()
def realDistance(x):
    fSign = 1
...
#--------------------------------------------
    ...
    try:
        ...
        img.draw_line(145,120,centerX,centerY, (255))
        #print(angleYellow)
    except: pass
    gray = img
    #print("distanceBlue")
